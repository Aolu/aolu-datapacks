...
playsound minecraft:entity.evoker.prepare_summon master @a ~ ~ ~ 0.2 1.2
execute if score @s aolu_s_level_2_spell matches 1 run function aolu_spells:spells/audio/charging_lava_ball
execute if score @s aolu_s_level_2_spell matches 2 run function aolu_spells:spells/audio/charging_restoration
