...
execute at @s as @a if score @s aolu_s_owner = @n aolu_s_owner at @e[distance=..4] unless score @s aolu_s_owner = @n aolu_s_owner run function aolu_spells:spells/damage/lava_ball with storage aolu_s_spells
