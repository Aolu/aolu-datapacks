...
execute if entity @s[advancements={aolu_spells:spells/shadow_spider=true}] unless score @s aolu_s_level_1_spell matches 2 run tellraw @s [{"bold":true,"color":"white","text":"└"},{"hoverEvent":{"action":"show_text","value":[{"text":"Summon Damage: 50% Spell Power\nSummon Health: 150% Spelll Power\nMax Amount Summoned: 3"}]},"clickEvent":{"action":"run_command","value":"/trigger aolu_s_set_level_1_spell set 2"},"bold":true,"color":"aqua","text":"SHADOW SPIDER"}]
execute if entity @s[advancements={aolu_spells:spells/shadow_spider=true}] if score @s aolu_s_level_1_spell matches 2 run tellraw @s [{"bold":true,"color":"white","text":"└"},{"hoverEvent":{"action":"show_text","value":[{"text":"Summon Damage: 50% Spell Power\nSummon Health: 150% Spelll Power\nMax Amount Summoned: 3"}]},"bold":true,"color":"aqua","text":"SHADOW SPIDER"},{"bold":true,"color":"white","text":" <-"}]
