...
execute at @s on target if entity @s[type=#aolu_spells:summon_ignore] run data remove entity @n[type=warden] anger
...
execute if score @s aolu_s_lifetime matches 10 run function aolu_spells:spells/summons/shadow_warden/sec
