...
execute at @s[type=!warden] on target if score @s[distance=..5] aolu_s_owner = @n aolu_s_owner run data merge entity @n {attributes:[{id:"minecraft:follow_range",base:0}]}
...
execute at @s[type=!warden] on target unless score @s aolu_s_owner = @n aolu_s_owner run data merge entity @n {attributes:[{id:"minecraft:follow_range",base:1000}]}

#RETARGET IF TARGET IS TOO FAR FROM OWNER
execute at @a if score @s[type=!warden] aolu_s_owner = @p aolu_s_owner at @s on target if entity @s[distance=20..] run data merge entity @n {attributes:[{id:"minecraft:follow_range",base:0}]}
