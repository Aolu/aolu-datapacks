...
execute if score @s aolu_psp_agilityxp >= #xpmax aolu_psp_const if score @s aolu_psp_agilitylv < #arpg.max_lvl aolu_psp_const run function aolu_plr_stat_prog:agility/levelup