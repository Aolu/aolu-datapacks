...
execute if score @s aolu_psp_sprint matches 100.. if score @s aolu_psp_agilitylv < #arpg.max_lvl aolu_psp_const at @s run function aolu_plr_stat_prog:titles/agility
