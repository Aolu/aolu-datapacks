...
execute store result storage aolu_psp:archery_arrow_vel d float 1 run scoreboard players get 10000 aolu_psp_const
execute store result storage aolu_psp:archery_arrow_vel v float 1 run scoreboard players get 10000 aolu_psp_const
