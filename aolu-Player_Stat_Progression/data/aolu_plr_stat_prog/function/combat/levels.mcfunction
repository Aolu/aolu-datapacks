...
execute if score @s aolu_psp_combatxp >= #xpmax aolu_psp_const if score @s aolu_psp_combatlv < #arpg.max_lvl aolu_psp_const run function aolu_plr_stat_prog:combat/levelup
