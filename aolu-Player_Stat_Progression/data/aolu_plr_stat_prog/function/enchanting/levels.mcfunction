...
execute if score @s aolu_psp_enchantxp >= #xpmax aolu_psp_const if score @s aolu_psp_enchantlv < aolu_psp_max_lv aolu_psp_const run function aolu_plr_stat_prog:enchanting/levelup
