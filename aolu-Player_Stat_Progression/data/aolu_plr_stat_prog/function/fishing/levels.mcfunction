...
execute if score @s aolu_psp_fishingxp >= #xpmax aolu_psp_const if score @s aolu_psp_fishinglv < #arpg.max_lvl aolu_psp_const run function aolu_plr_stat_prog:fishing/levelup
