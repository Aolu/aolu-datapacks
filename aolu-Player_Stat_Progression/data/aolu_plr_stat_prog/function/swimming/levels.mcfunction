...
execute if score @s aolu_psp_swimxp >= #xpmax aolu_psp_const if score @s aolu_psp_swimlv < #arpg.max_lvl aolu_psp_const run function aolu_plr_stat_prog:swimming/levelup
