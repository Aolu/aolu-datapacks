...
execute on passengers unless data entity @s {powered:1b} anchored eyes at @s facing entity @e[distance=..12,limit=1,sort=nearest,tag=!aolu_tb_orb,tag=!aolu_tb_ignore,type=!#aolu_trident_buffs:ignore] eyes run function aolu_trident_buffs:aqua_orb/shoot
execute on passengers if data entity @s {powered:1b} anchored eyes at @s facing entity @e[distance=..20,limit=1,sort=nearest,tag=!aolu_tb_orb,tag=!aolu_tb_ignore,type=!#aolu_trident_buffs:ignore] eyes run function aolu_trident_buffs:aqua_orb/shoot
