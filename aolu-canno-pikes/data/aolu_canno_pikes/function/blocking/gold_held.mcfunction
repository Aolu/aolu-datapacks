...
execute store result storage aolu_cno audio_pitch float 6 run scoreboard players get @s aolu_cno_block_timer
...
execute if score @s aolu_cno_block_timer matches 17.. run function aolu_canno_pikes:on_block/parry_failed
