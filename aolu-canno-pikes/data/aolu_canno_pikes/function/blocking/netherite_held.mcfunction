...
execute if score @s aolu_cno_charge matches 10.. if entity @s[tag=aolu_cno_sneaking] positioned ~ ~1 ~ run particle soul_fire_flame ^ ^ ^1 0 0 0 0 1
execute store result storage aolu_cno audio_pitch float 32 run scoreboard players get @s aolu_cno_block_timer
