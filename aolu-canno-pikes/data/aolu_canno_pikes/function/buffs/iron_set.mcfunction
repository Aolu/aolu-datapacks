...
execute store result storage aolu_cno damage_conversion float 0.005 run scoreboard players get @s aolu_cno_buff_value
execute store result storage aolu_cno attack_speed_conversion float 0.0025 run scoreboard players get @s aolu_cno_buff_value
