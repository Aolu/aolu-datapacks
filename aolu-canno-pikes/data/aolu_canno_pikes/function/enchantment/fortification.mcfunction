...
execute if entity @s[advancements={aolu_canno_pikes:blocking = true}] if score @s aolu_cno_fortify matches 17 run playsound item.armor.equip_netherite player @a ~ ~ ~ 1 0.5
