...
execute if entity @s[advancements={aolu_canno_pikes:blocking = true}] if score @s aolu_cno_fortify matches 17 run playsound minecraft:item.mace.smash_air ambient @a ~ ~ ~ 1 1.5
