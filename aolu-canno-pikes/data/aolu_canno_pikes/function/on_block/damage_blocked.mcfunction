...
execute store result storage aolu_cno block_to_charge int 0.1 run scoreboard players get @s aolu_cno_blocked_damage
...
# blocking while shooting has shield health instead of duration
