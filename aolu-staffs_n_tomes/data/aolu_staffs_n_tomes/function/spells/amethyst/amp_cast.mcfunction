...
data modify storage aolu_snt:spell_velocity y set value .4d
execute positioned ~ ~2 ~ run summon armor_stand ^ ^ ^2 {Silent:1b,Invulnerable:1b,Small:1b,Invisible:1b,NoBasePlate:1b,Tags:["aolu_snt_spell","aolu_snt_amp","aolu_snt_proj"],DisabledSlots:4144959}
