...
data modify storage aolu_snt:spell_velocity z set value 2.5d
...
execute store result entity @n[tag=aolu_snt_proj] damage float .003 run attribute @s attack_damage get 100
