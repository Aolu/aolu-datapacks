...
execute if score @s aolu_snt_lifetime matches 2 store result storage aolu_snt:spell_damage a double 1.25 at @a if score @s aolu_cr_pid = @p aolu_cr_pid run attribute @p attack_damage get
execute if score @s[tag=aolu_snt_weak_spike] aolu_snt_lifetime matches 2 store result storage aolu_snt:spell_damage a double 0.5 at @a if score @s aolu_cr_pid = @p aolu_cr_pid run attribute @p attack_damage get
execute if score @s aolu_snt_lifetime matches 2 as @a if score @s aolu_cr_pid = @n aolu_cr_pid at @e[distance=.1..3] unless score @s aolu_cr_pid = @n aolu_cr_pid run function aolu_staffs_n_tomes:spells/amethyst/spike_damage with storage aolu_snt:spell_damage
