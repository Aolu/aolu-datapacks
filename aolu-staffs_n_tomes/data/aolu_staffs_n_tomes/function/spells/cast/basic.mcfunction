...
$execute rotated as @s positioned 0.0 0.0 0.0 positioned ^ ^$(y) ^$(z) summon area_effect_cloud run data modify entity @e[tag=aolu_snt_proj,limit=1] Motion set from entity @s Pos
