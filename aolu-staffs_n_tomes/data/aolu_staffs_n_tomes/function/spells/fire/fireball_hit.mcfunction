...
execute on origin positioned ~-2 ~-2 ~-2 at @e[dx=2,dy=2,dz=2,type=!#aolu_staffs_n_tomes:ignore] unless score @s aolu_snt_pid = @n aolu_snt_pid run function aolu_staffs_n_tomes:spells/fire/fireball_damage with storage aolu_snt:spell_damage
