...
execute at @e[distance=..8,limit=5,type=!#aolu_common_resources:ignore] unless score @n aolu_cr_pid = @s aolu_cr_pid run summon armor_stand ~ ~ ~ {Marker:1b,Silent:1b,Invulnerable:1b,Small:1b,Invisible:1b,NoBasePlate:1b,Tags:["aolu_snt_spell","aolu_snt_geyser","aolu_snt_proj"],DisabledSlots:4144959}
