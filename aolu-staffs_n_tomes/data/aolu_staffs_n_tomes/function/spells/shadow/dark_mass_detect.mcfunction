 ...
 execute as @a if score @s aolu_cr_pid = @n[tag=aolu_snt_dark_mass] aolu_cr_pid unless score @s aolu_cr_pid = @n[type=!#aolu_common_resources:ignore,tag=!aolu_snt_dark_mass] aolu_cr_pid store result storage aolu_snt:spell_damage dmw float .5 run attribute @s attack_damage get
