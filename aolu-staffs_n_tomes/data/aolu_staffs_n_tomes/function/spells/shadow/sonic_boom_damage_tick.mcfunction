...
execute if entity @e[tag=aolu_snt_boom_target] as @a if score @s aolu_snt_pid = @n[tag=aolu_snt_sonic_boom_damage] aolu_snt_pid run function aolu_staffs_n_tomes:spells/shadow/sonic_boom_damage_found
