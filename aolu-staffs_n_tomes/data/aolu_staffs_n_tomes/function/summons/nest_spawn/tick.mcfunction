...
execute if score #temp aolu_snt_lifetime matches 0 as @e[distance=0.1..10,limit=1,sort=random] unless score @s aolu_cr_pid = @n[tag=aolu_snt_nest_spawn] aolu_cr_pid run damage @n[tag=aolu_snt_nest_spawn] 1 out_of_world by @s
