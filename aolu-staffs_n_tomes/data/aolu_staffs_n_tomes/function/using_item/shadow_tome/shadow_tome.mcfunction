...
execute if score @s aolu_snt_cast_time matches 2 run playsound block.sculk_sensor.clicking_stop master @a ~ ~ ~ 1 0
execute if score @s aolu_snt_cast_time matches 2 run playsound block.sculk_sensor.clicking_stop master @a ~ ~ ~ 1 0
execute if score @s aolu_snt_cast_time matches 2 run playsound block.sculk_sensor.clicking_stop master @a ~ ~ ~ 1 0
execute if score @s aolu_snt_cast_time matches 2 run playsound minecraft:entity.guardian.ambient master @a ~ ~ ~ 1 2
