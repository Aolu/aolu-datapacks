...
execute if predicate aolu_staffs_n_tomes:holding_weapon/shadow_tome if score @s aolu_snt_selected_spell matches 2 run item modify entity @s weapon.mainhand aolu_staffs_n_tomes:crossbow_anim
execute if predicate aolu_staffs_n_tomes:holding_weapon/shadow_tome if score @s aolu_snt_selected_spell matches 3 run item modify entity @s weapon.mainhand aolu_staffs_n_tomes:spyglass_anim
...
execute if predicate aolu_staffs_n_tomes:holding_weapon/shadow_tome_offhand if score @s aolu_snt_selected_spell matches 2 run item modify entity @s weapon.offhand aolu_staffs_n_tomes:crossbow_anim
execute if predicate aolu_staffs_n_tomes:holding_weapon/shadow_tome_offhand if score @s aolu_snt_selected_spell matches 3 run item modify entity @s weapon.offhand aolu_staffs_n_tomes:spyglass_anim
