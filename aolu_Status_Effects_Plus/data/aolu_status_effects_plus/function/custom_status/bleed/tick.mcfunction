...
execute if predicate aolu_status_effects_plus:status_conditions/regeneration run function aolu_status_effects_plus:custom_status/bleed/remove
...
scoreboard players set @s aolu_psp_regtimer 100