...
advancement revoke @s only aolu_status_effects_plus:damage_sources/crunch_melee_hurt
...
execute on attacker run advancement revoke @s only aolu_status_effects_plus:damage_sources/crunch_melee_hit
