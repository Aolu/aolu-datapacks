...
execute if score @s amv_elite_type matches 1 run function aolu_monster_variants:zzz/37
execute if score @s amv_elite_type matches 2 run function aolu_monster_variants:zzz/38
execute if score @s amv_elite_type matches 3 run function aolu_monster_variants:zzz/39
execute if score @s amv_elite_type matches 4 run function aolu_monster_variants:zzz/40
execute if score @s amv_elite_type matches 5 run function aolu_monster_variants:zzz/41
execute if score @s amv_elite_type matches 6 run function aolu_monster_variants:zzz/42
execute if score @s amv_elite_type matches 7 run function aolu_monster_variants:zzz/43