...
execute if score @s amv_ability_cooldown matches 1.. run function aolu_monster_variants:zzz/4
execute if score @s amv_summon_cooldown matches 1.. run function aolu_monster_variants:zzz/5
