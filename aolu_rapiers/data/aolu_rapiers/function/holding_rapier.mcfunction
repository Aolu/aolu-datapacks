...
execute if score @s aolu_rp.thrust_charges matches 1.. run function aolu_rapiers:zzz/7
execute if score #ifelse mcb.internal matches 0 if entity @s[tag=!aolu_rp.dashing] run function aolu_rapiers:zzz/8
scoreboard players set #ifelse mcb.internal 0
execute if entity @s[tag=aolu_rp.thrust_mode,tag=!aolu_rp.dashing] run function aolu_rapiers:zzz/9
execute if score #ifelse mcb.internal matches 0 run function aolu_rapiers:zzz/11
