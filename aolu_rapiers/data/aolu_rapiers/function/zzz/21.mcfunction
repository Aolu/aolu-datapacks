...
effect give @s minecraft:wind_charged 1 1
execute if score @s aolu_rp.thrust_charges matches 5.. run function aolu_rapiers:zzz/22
function aolu_rapiers:get_kinetic_damage
